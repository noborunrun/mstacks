...
//  isbn.text = @"9784774138381";
  ...
  StackStockBooks *ssb = [[StackStockBooks alloc] initWithGetBookInfoOfISBN:isbn.text];
  ...
  if ([bookInfo count] < 1) {
    ...
    [alert initWithTitle:@"Error" message:@"ISBNが間違えているか、StackStockBooksに書籍情報がありません。"
